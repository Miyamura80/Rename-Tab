...
**Pin the toolbar icon now** — it's the main way you'll trigger a rename. Click the
...
| **A global shortcut** *(optional)* | Assign one at `chrome://extensions/shortcuts` (e.g. `Alt+R`) — fires even from the tab strip. |
